package cn.zhangzuofeng.daily.util;
...
public class ZResource {
    ...
    static {
        try {
            resources = ResourceBundle.getBundle("cn.zhangzuofeng.daily.util.resources.Daily",
                    Locale.getDefault());
        } catch (MissingResourceException mre) {
            System.err.println("cn/zhangzuofeng/daliy/util/resources/Daily.properties not found");
            System.exit(1);
        }
    }
