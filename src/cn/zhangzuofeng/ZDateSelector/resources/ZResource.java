package cn.zhangzuofeng.ZDateSelector.resources;
...
public class ZResource {
    ...
    static {
        try {
            resources = ResourceBundle.getBundle("cn.zhangzuofeng.ZDateSelector.resources.Daily",
                    Locale.getDefault());
        } catch (MissingResourceException mre) {
            System.err.println("cn/zhangzuofeng/ZDateSelector/resources/Daily.properties not found");
            System.exit(1);
        }
    }
